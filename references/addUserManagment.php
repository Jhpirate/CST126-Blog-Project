...
function renderForm($id, $firstname, $lastname, $error)
{
    ...
    <form action="" method="post">
        ...
        <div>
            ...
            <strong>First Name: *</strong> <input type="text" name="firstname" value="<?php
            echo $firstname;
            ?>"/><br/>

            <strong>Last Name: *</strong> <input type="text" name="lastname" value="<?php
            echo $lastname;
            ?>"/><br/>
...
if (isset($_POST['submit'])) {
    ...
    if (is_numeric($_POST['id'])) {
        ...
        if ($firstname == '' || $lastname == '') {
            ...
            mysqli_query("UPDATE players SET firstname='$firstname', lastname='$lastname' WHERE id='$id'") or die(mysqli_error());
